...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ContentValues cvLevelList = new ContentValues();
        ...
        for (int i = 0; i < levelNames.length; i++) {
            cvLevelList.put(TableLevelList.FIELD_LEVEL_NAME, levelNames[i]);
            db.insert(TableLevelList.TABLE_NAME, null, cvLevelList);
        }
